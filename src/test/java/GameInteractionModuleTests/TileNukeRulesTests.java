...
//        Settlement s1 = new Settlement(coord2, game.getCurrentPlayer(), 1);
...
//        assert affectedSettlements.size() == 2;
    ...
    @Test
    public void nukeLvl3Test() {
        game = new GameState();
        setupHexAndTilesOnGameState(game);
        ArrayList<Coordinate> nukeCoords = new ArrayList<>();
        ArrayList<TerrainType> nukeTerrain = new ArrayList<>();

        nukeCoords.add(new Coordinate(100, 100));
        nukeCoords.add(new Coordinate(99, 99));
        nukeCoords.add(new Coordinate(99,100));

        nukeTerrain.add(TerrainType.VOLCANO);
        nukeTerrain.add(TerrainType.GRASS);
        nukeTerrain.add(TerrainType.GRASS);


        Tile nukeTile = new Tile(nukeCoords,nukeTerrain);
        game.levelTile(nukeTile);

        nukeCoords.clear();
        nukeTerrain.clear();

        nukeCoords.add(new Coordinate(101,99));
        nukeCoords.add(new Coordinate(100,99));
        nukeCoords.add(new Coordinate(101,100));

        nukeTerrain.add(TerrainType.VOLCANO);
        nukeTerrain.add(TerrainType.GRASS);
        nukeTerrain.add(TerrainType.GRASS);

        Tile nukeTile2 = new Tile(nukeCoords, nukeTerrain);
        game.levelTile(nukeTile2);
        ...
        Tile nukeTile3 = new Tile(nukeCoords,nukeTerrain);
        game.levelTile(nukeTile3);

        game.foundSettlement(new Coordinate(98,99), game.getCurrentPlayer());
        game.expandSettlement(new Coordinate(98,99), game.getCurrentPlayer(),TerrainType.GRASS);
